...
class SuffixArray
{
    ...
    public static void makeSuffixArray( int [ ] s, int [ ] SA, @Positive int n, int K )
    {
        @NonNegative int n0 = ( n + 2 ) / 3;
        @NonNegative int n1 = ( n + 1 ) / 3;
        @NonNegative int n2 = n / 3;
        int t = n0 - n1;  // 1 iff n%3 == 1
        @NonNegative int n12 = n1 + n2 + t;
